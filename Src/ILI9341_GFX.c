...
void ILI9341_ShowRoadSigns(signs road)
{
    ...
    {
    case velocity:
    	ILI9341_DrawText("you have to lower", FONT4, 30, 150, BLACK, WHITE);
    	ILI9341_DrawText("  your velocity", FONT4, 30, 170, BLACK, WHITE);
    	break;
    case residential:
    	ILI9341_DrawText("Residential Area", FONT4, 30, 150, BLACK, WHITE);
    	break;
    case oneway:
    	ILI9341_DrawText("ONE WAY", FONT4, 30, 150, BLACK, WHITE);
    	break;
    case noentry:
		ILI9341_DrawText("NO ENTRY", FONT4, 30, 150, BLACK, WHITE);
		break;
    case stop:
		ILI9341_DrawText("STOP", FONT4, 30, 150, BLACK, WHITE);
		break;
    case speedlimit:
    	ILI9341_DrawText("SPEED LIMIT", FONT4, 30, 150, BLACK, WHITE);
    	break;
    case nocycling:
    ...
    case roadworks:
		...
		break;
    case giveaway:
		ILI9341_DrawText("GIVE AWAY", FONT4, 30, 150, BLACK, WHITE);
		break;
    default:
    	break;
    }
